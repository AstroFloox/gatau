...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'Astr001') return res.json(loghandler.invalidKey)
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/vietnam.json`))
...
router.get('/cewe/thailand', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/thailand.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/china', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/china.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/indonesia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/indonesia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/korea', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/korea.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/japan', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/japan.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/cewe/malaysia', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Astr001')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Astroofc/Asupan/main/cecan/malaysia.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/canvas/welcome', async (req, res, next) => {
        ...
        bg = req.query.bg,
            type = req.query.type        
    if (!name) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter name"})
    if (!gcname) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter gcname"})
    if (!ppgc) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter ppgc"})
    if (!member) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter member"})
    if (!pp) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter pp"})
    if (!bg) return res.json({ status : false, creator : `${creator}`, message : "masukkan parameter bg"})
    
       fetch(encodeURI(`https://api-dapuhy.herokuapp.com/api/canvas/welcome?&apikey=Kirbotz123`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
https://api-dapuhy.herokuapp.com/api/canvas/welcome?name=Dappa&gcname=BOT%20WHATSAPP&ppgc=https://i.ibb.co/t4NXshJ/images-3.jpg&member=147&pp=https://i.ibb.co/Zxg1HB6/akaza2.jpg&bg=https://i.ibb.co/tYgwwT2/images-2.jpg&apikey=beta
